...
const Summary = ({
  ...
  return (
    <div className="flex flex-col gap-[20px] w-full 768:max-w-[400px]">
        ...
        <div className="w-full rounded-xl p-[25px] bg-primary-lighter gap-[20px] flex flex-col justify-between">
            <div className="w-full flex flex-col gap-[10px]">
                <div className="flex items-center justify-between text-[14px] text-secondary">
                    <span>Toplam</span>
                    <span>{data ? formatter.format(data.subtotal) : '0 TL'}</span>
                </div>
                <div className="flex items-center justify-between text-[14px] text-secondary">
                    <span>İndirim</span>
                    <span>{data ? formatter.format(data.subtotal - data.total) : '0 TL'}</span>
                </div>
                <div className="flex items-center justify-between text-[14px] text-white font-semibold">
                    <span>Ara Toplam</span>
                    <span className="text-[18px] mt-[10px]">{data ? formatter.format(data.total) : '0 TL'}</span>
                </div>
